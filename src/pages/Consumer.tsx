...
const Consumer: React.FC<ConsumerProps> = ({ onOpenBeta }) => {
  ...
  const content = useMemo(() => ({
    en: {
      ...
      benefitsSubtitle: "Experience the future of shopping and investing simultaneously"
    },
    es: {
      ...
      benefitsSubtitle: "Experimentá el futuro de comprar e invertir en simultáneo"
    }
  }), []);
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="relative max-w-5xl mx-auto">
            ...
            <div
              ...
              style={{ background: "rgba(34,59,98,0.70)", backdropFilter: "blur(4px)" }}
            />
          </div>
        </div>
      </section>
          ...
          <div className="max-w-3xl mx-auto space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <a
                ...
                className="inline-flex items-center gap-3 px-5 py-3 rounded-xl transition-all duration-200 hover:scale-105 active:scale-95"
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-white font-semibold text-base leading-none">App Store</div>
                </div>
              </a>
              ...
              >
                <svg className="w-7 h-7 flex-shrink-0" viewBox="0 0 24 24" fill="none">
                  <path d="M3.18 23.5c.3.17.64.2.97.1L14.76 12 11 8.24 3.18 23.5z" fill="#EA4335"/>
                  <path d="M20.5 10.56l-2.54-1.47-3.48 3.48 3.48 3.48 2.56-1.48c.73-.42.73-1.59-.02-2.01z" fill="#FBBC04"/>
                  <path d="M3.18.5C2.88.67 2.67 1 2.67 1.42v21.16c0 .42.21.75.51.92L14.76 12 3.18.5z" fill="#34A853"/>
                  <path d="M14.76 12L3.18.5c.33-.1.67-.07.97.1L17.96 8.1l-3.2 3.9z" fill="#4285F4"/>
                </svg>
                <div className="text-left">
                  <div className="text-white/60 text-xs leading-none mb-0.5">GET IT ON</div>
                  <div className="text-white font-semibold text-base leading-none">Google Play</div>
                </div>
              </a>
            </div>
          </div>
