...
import { Users, TrendingUp, Shield, Smartphone, CreditCard, BarChart3, Store, Handshake, ArrowRight } from "lucide-react";
      ...
      <section className="py-12 md:py-14" style={{ background: "var(--color-bg-dark)" }}>
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              <Store size={26} style={{ color: "var(--color-accent)" }} />
            </div>
            <div className="flex-1 text-center md:text-left">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-white mb-1">
                {language === "en" ? "Calculate how much you could save" : "Calculá cuánto podrías ahorrar"}
              </h3>
              <p className="text-sm" style={{ color: "rgba(255,255,255,0.6)" }}>
                {language === "en"
                  ? "Enter your monthly volume and instantly see your savings with UX Dual."
                  : "Ingresá tu volumen mensual y mirá al instante tu ahorro con UX Dual."}
              </p>
            </div>
            <Link
              to="/comercios"
