...
const translations = {
  es: {
    ...
    heroSubtitle: "Compará cuánto podés ganar en un mes usando UX Dual.",
    ...
    hintInitial: "¿Cuánto tenés disponible al inicio del mes?",
  ...
  en: {
    ...
    heroSubtitle: "See how much you could earn in a month using UX Dual.",
    ...
    hintInitial: "How much do you have available at the start of the month?",
