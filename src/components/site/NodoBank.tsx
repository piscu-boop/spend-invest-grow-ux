      ...
      <div className="relative mx-auto max-w-6xl">
        ...
        <div className="max-w-3xl">
          ...
          <FadeUp delay={0.05}>
            <h2 className="mt-6 text-balance font-display text-4xl leading-[1.1] sm:text-5xl md:text-6xl">
              Tu banco. Tus clientes. Nuestra tecnología.
            </h2>
          </FadeUp>
          <FadeUp delay={0.1}>
            <p className="mt-7 max-w-xl text-lg leading-[1.7] text-uxc-muted-foreground">
              Con UX Nodo Bank, tu banco ofrece algo unico; Pagos con Inversion.
              Más activos bajo gestión. Clientes más leales. Todo sobre tu
        ...
        <ScaleIn delay={0.15} className="mt-20">
          <div className="glass rounded-3xl p-8 md:p-12">
            <p className="eyebrow text-uxc-muted-foreground">Cómo funciona</p>
          ...
          <div className="mt-24 overflow-hidden rounded-3xl border border-white/10 bg-[#0c1220]">
            <div className="grid lg:grid-cols-2">
              <div className="p-10 md:p-12">
                <p className="eyebrow text-blue">Integración técnica</p>
                <h3 className="mt-5 font-display text-3xl md:text-4xl">
                  Una llamada. Cinco campos. Listo.
                </h3>
                <p className="mt-5 text-[15px] leading-[1.7] text-uxc-muted-foreground">
                  Documentación completa, sandbox público, SDKs para los
                  stacks más usados en bancos LATAM. Compliance, idempotencia
                  y trazabilidad de auditoría desde el primer request.
                </p>
                <a
                  href="#contacto"
