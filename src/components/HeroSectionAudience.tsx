...
const HeroSectionAudience: React.FC<HeroSectionAudienceProps> = ({ onOpenBeta }) => {
	...
	const handleConsumerClick = () => {
		navigate("/consumer#hero");
	};

      const handleMerchantClick = () => {
        navigate("/merchant#hero");
      };

      const handleManufacturerClick = () => {
        navigate("/manufacturer#hero");
      };
	...
	return (
		...
		<div className="absolute inset-0 pointer-events-none">
			<div className="absolute top-20 right-20 w-96 h-96 bg-ux-green/10 rounded-full blur-3xl pointer-events-none"></div>
			<div className="absolute bottom-20 left-20 w-64 h-64 bg-ux-green/5 rounded-full blur-2xl pointer-events-none"></div>
		</div>


			<div className="container mx-auto px-4 pt-20 pb-10">
				<div className="grid lg:grid-cols-2 gap-12 items-center justify-items-center relative z-10">
					<div className="space-y-8 text-center lg:text-left relative z-10">
						...
						<div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start relative z-10">
							<Button
								type="button"
								className="border-[#0E1B38] bg-[#0E1B38] text-white hover:bg-blue-900/70 hover:text-ux-green px-8 py-4 text-lg rounded-full font-semibold transition-all duration-300 shadow-lg cursor-pointer relative z-10"
							...
							<Button
								type="button"
								variant="outline"
								className="border-slate-800 bg-slate-800 text-white hover:bg-blue-900/40 hover:text-ux-green px-8 py-4 text-lg rounded-full font-semibold transition-all duration-300 cursor-pointer relative z-10"
					...
					<div className="relative flex justify-center pointer-events-none">
						<div className="relative pointer-events-none">
							<div className="absolute inset-0 w-[500px] h-[500px] bg-gradient-to-r from-ux-green/20 to-ux-green/10 rounded-full blur-2xl transform -translate-x-16 -translate-y-16 pointer-events-none"></div>
							<div className="relative z-10 pointer-events-none">
								<img
									src="lovable-uploads/200931e1-23f7-4c91-8aa2-73df09bab162.png"
									alt="UX Dual App Interface"
									className="w-[450px] h-auto drop-shadow-2xl pointer-events-none"
									loading="lazy"
								/>
							</div>
						</div>
